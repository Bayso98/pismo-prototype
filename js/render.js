...
const ROWS = {
  novo: { variant: 'default', items: [
    { title: 'Such a Fun Age', author: 'James Sulivan', price: '18.90 KM', img: 'assets/03-novo-cover-1.png?r=2' },
    { title: 'Crna ptica', author: 'James Sulivan', price: '18.90 KM', img: 'assets/03-novo-cover-2.png?r=2' },
    { title: 'Minesote', author: 'Ju Nesbe', price: '18.90 KM', img: 'assets/03-novo-cover-3.png?r=2' },
    { title: '1984 - ŽIVOTINJSKA FARMA', author: 'Džordž Orvel', price: '18.90 KM', img: 'assets/03-novo-cover-4.png?r=2' },
    { title: 'Chinook', author: 'Sejranović Bekim', price: '18.90 KM', img: 'assets/03-novo-cover-5.png?r=2' },
  ]},
  djeca: { variant: 'default', items: [
    { title: 'Gdje je Mica Maca?', author: 'Marijke Klompmaker', price: '18.90 KM', img: 'assets/07-djeca-cover-1.png?r=2' },
    { title: 'Sjajni svijet Toma Gatesa', author: 'Liz Pichon', price: '18.90 KM', img: 'assets/07-djeca-cover-2.png?r=2' },
    { title: 'Neverovatan svet dinosaurusa', author: 'Grupa autora', price: '18.90 KM', img: 'assets/07-djeca-cover-3.png?r=2' },
    { title: 'Crvenkapica - Mala lektira', author: 'Grupa autora', price: '18.90 KM', img: 'assets/07-djeca-cover-4.png?r=2' },
    { title: 'Velike svjetske rijeke', author: 'V. Mehnert, M. Haake', price: '18.90 KM', img: 'assets/07-djeca-cover-5.png?r=2' },
  ]},
  psiho: { variant: 'quick', items: [
    { title: 'Moć podsvijesti', author: 'Joseph Murphy', price: '19.00 KM', img: 'assets/08-psiho-cover-1.png?r=2' },
    { title: 'Odrasla deca emocionalno nezrelih roditelja', author: 'Lindzi Gibson', price: '26.00 KM', img: 'assets/08-psiho-cover-2.png?r=2' },
    { title: 'Održiva prehrana za svaki dan', author: 'Marizela Šabanović', price: '58.50 KM', old: '69.90 KM', img: 'assets/08-psiho-cover-3.png?r=2' },
    { title: 'Počni sa zašto', author: 'Simon Sinek', price: '22.00 KM', img: 'assets/08-psiho-cover-4.png?r=2' },
    { title: 'Razoružavanje narcisa', author: 'Vendi Bahari', price: '27.00 KM', img: 'assets/08-psiho-cover-5.png?r=2' },
  ]},
  hist: { variant: 'default', items: [
    { title: 'Bosanski muslimani u Drugom svjetskom ratu', author: 'Marko Attila Hoare', price: '35.00 KM', old: '45.90 KM', img: 'assets/09-hist-cover-1.png?r=2' },
    { title: 'Bosna i Bošnjaci', author: 'Enes Durmišević', price: '45.00 KM', old: '64.90 KM', img: 'assets/09-hist-cover-2.png?r=2' },
    { title: 'Bosna i Hercegovina u spisima Ahmeda Dževdet-paše', author: 'Kerima Filan - priredila i prevela', price: '19.50 KM', img: 'assets/09-hist-cover-3.png?r=2' },
    { title: 'Sarajevski dugi pucnji 1914.', author: 'V. Preljević, C. R. priredili', price: '18.90 KM', img: 'assets/09-hist-cover-4.png?r=2' },
    { title: 'Such a Fun Age', author: 'James Sulivan', price: '18.90 KM', img: 'assets/09-hist-cover-5.png?r=2' },
  ]},
  naucna: { variant: 'quick', items: [
    { title: 'Kulturno pamćenje', author: 'Jan Assman', price: '18.90 KM', img: 'assets/10-naucna-cover-1.png?r=2' },
    { title: 'Izborni sistemi u Jugoslaviji', author: 'Hamdija Ćemerlić', price: '18.90 KM', img: 'assets/10-naucna-cover-2.png?r=2' },
    { title: 'Između vere i nacije', author: 'Ivan Ejub Kostić', price: '18.90 KM', img: 'assets/10-naucna-cover-3.png?r=2' },
    { title: 'Osnove ekonomije:', author: 'Ivan Ejub Kostić', price: '18.90 KM', img: 'assets/10-naucna-cover-4.png?r=2' },
    { title: 'Pax Americana', author: 'Zijad Šehić', price: '18.90 KM', img: 'assets/10-naucna-cover-5.png?r=2' },
  ]},
  klasici: { variant: 'default', items: [
    { title: 'Such a Fun Age', author: 'Jane Austen', price: '18.90 KM', img: 'assets/11-klasici-cover-1.png?r=2' },
    { title: 'To Kill a Mockingbird', author: 'Harper Lee', price: '18.90 KM', img: 'assets/11-klasici-cover-2.png?r=2' },
    { title: 'One Hundred Years of Solitude', author: 'Gabriel García Márquez', price: '18.90 KM', img: 'assets/11-klasici-cover-3.png?r=2' },
    { title: 'Brave New World', author: 'Aldous Huxley', price: '18.90 KM', img: 'assets/11-klasici-cover-4.png?r=2' },
    { title: 'I Capture The Castle', author: 'Dodie Smith', price: '18.90 KM', img: 'assets/11-klasici-cover-5.png?r=2' },
  ]},
  pokloni: { variant: 'quick', items: [
    { title: 'Uno Flip', author: undefined, price: '18.90 KM', img: 'assets/11-pokloni-cover-1.png?r=2' },
    { title: 'Tabu XL', author: undefined, price: '18.90 KM', img: 'assets/11-pokloni-cover-2.png?r=2' },
    { title: 'Baby Yoda figure', author: undefined, price: '18.90 KM', img: 'assets/11-pokloni-cover-3.png?r=2' },
    { title: 'Harry Potter Prop', author: undefined, price: '18.90 KM', img: 'assets/11-pokloni-cover-4.png?r=2' },
    { title: 'Yume Spy X Family Squish', author: undefined, price: '18.90 KM', img: 'assets/11-pokloni-cover-5.png?r=2' },
  ]},
};
